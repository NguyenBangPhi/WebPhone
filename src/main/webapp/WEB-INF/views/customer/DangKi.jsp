...
<body>
    ...
    <section>
        <form>
            <h1>Đăng Kí</h1>
            <label>
              <p class="label-txt">Mã Đăng Nhập</p>
              <input type="text" class="input" name="makh">
              <div class="line-box">
                <div class="line"></div>
              </div>
            </label>
            ...
            <label>
              <p class="label-txt">Tên Khách Hàng</p>
              <input type="text" class="input" name="tenkh">
              <div class="line-box">
                <div class="line"></div>
              </div>
            </label>
            <label>
                <p class="label-txt">Giới tính</p>
                <input type="radio" name="gioitinh" value="true"> Nam
                <input type="radio" name="gioitinh" value="false">  Nữ
            </label>
            <label>
                <p class="label-txt">Ngày sinh</p>
                <input type="date" class="input" name="ns">
                <div class="line-box">
                  <div class="line"></div>
                </div>
              </label>
            ...
            <button type="submit" class="btn btn-success" formaction="/index/dangki/add">Đăng kí</button>
          </form>
          <p>${message}</p>
    </section>
