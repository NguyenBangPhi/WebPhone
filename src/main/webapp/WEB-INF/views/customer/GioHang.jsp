...
<body>
    ...
    <section class="cart">
        <h1 class="text-center" style="font-weight: 700;">Giỏ Hàng</h1>
        <div class="w-100">
            <table class="table">
                <thead>
                  <tr>
                ...
                <tbody>
                    ...
                    <td>
                        <div class="d-flex ">
                            <div>
                                <img src="/customer/images/${item.sp.hinh}" alt="" width="100px">
                            </div>
                            <div>
                                <p>${item.sp.tensp}</p>
                                <c:set value="${item.sp.dongia}" var="gia"/>
                                <p>Giá : <fmt:formatNumber value="${gia}"/></p>
                                <p>Số lượng:  ${item.sp.soluonghang}</p>
                            </div>
                        </div>
                    </td>
                    <td>
                    	<form action="" style="width: 100%;margin: 0px;background: #fff;padding: 0px;box-shadow: 0px 0px 0px">
                        <div class="form-group d-flex"> 
                        		<input type="hidden" name="items${item.sp.masp}" value="${item.soluong-1}">
	                        	<button class="btn btn-danger" formaction="/index/cart/update/${item.sp.masp}">
	                                <i class="fa fa-angle-left"></i>
	                            </button>
	                            <input type="hidden" name="items${item.sp.masp}" value="${item.soluong+1}">
	                            <input type="text" class="form-control p-1" id="soLuong" style="width: 40px !important;" value="${item.soluong}" name="item${item.sp.masp}">
	                            <button class="btn btn-danger" formaction="/index/cart/update/${item.sp.masp}">
                    ...
                    <c:set value="${item.tongtien}" var="tongtien"/>
                    <td><fmt:formatNumber value="${tongtien}"/></td>
                    <td>
                        <a href="/index/cart/remove/${item.sp.masp}" style="font-size: 30px;">
              ...
              <div class="text-center">
              		<form style="width: 100%;margin: 0px;background: none;text-align: left;">
					  <div class="form-group">
					    <label class="m-0"  for="exampleInputEmail1">Địa chỉ nhận hàng</label>
					    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="diachinh">
					  </div>
					  <div class="form-group">
					    <label class="m-0"  for="exampleInputEmail1">Số điện thoại</label>
					    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="sdt">
					  </div>
					  <div class="form-check">
						  <input class="form-check-input" type="radio" name="trangthai" id="exampleRadios1" value="TRUE">
						  <label style="margin: 0px 0px;" class="form-check-label" for="exampleRadios1">
						    Đã thanh toán 
						  </label>
						</div>
						<div class="form-check">
						  <input class="form-check-input" type="radio" name="trangthai" id="exampleRadios2" value="FALSE" checked>
						  <label class="m-0 form-check-label" for="exampleRadios2">
						    Chưa thanh toán
						  </label>
						</div>
					  <button type="submit" class="btn btn-primary" formaction="/index/cart/dathang">Đặt Hàng</button>
					</form>
